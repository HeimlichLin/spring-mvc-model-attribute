...
public class RequestMappingAndParamDemoController {
	...
	private static Logger LOGGER = LoggerFactory
			.getLogger(RequestMappingAndParamDemoController.class);
	...
	public String requestMappongAndParamTest1(
	...
	public String requestMappingAndParamTest2(
			@RequestParam("orgname") String orgName, Model model) {
		model.addAttribute("orgname", orgName);
	...
	public String requestMappingAndParamTest4(
			@RequestParam(value = "orgname", defaultValue = "Anonymous Org") String orgName,
			Model model) {
		model.addAttribute("orgname", orgName);
	...
	public String requestMappingAndParamTest5(@RequestParam String orgname,
			Model model) {
		model.addAttribute("orgname", orgname);
	...
	// test 6, subtest 3: Testing @RequestMapping with multiple request params
	@RequestMapping(value = "/test6/subtest3", method = RequestMethod.GET, params = {
			"orgname", "empcount" })
	public String requestMappingAndParamTest6Subtest3(
			@RequestParam String orgname, @RequestParam String empcount,
			Model model) {
		model.addAttribute("orgname", orgname);
	...
	// with single param
	@RequestMapping(value = "/test6/subtest4", method = RequestMethod.GET, params = {
			"orgname", "empcount" })
	...
	public String requestMappingAndParamTest7and8(@RequestParam String orgname,
